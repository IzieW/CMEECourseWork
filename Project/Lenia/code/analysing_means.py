# !/usr/bin/env python3
"""Analyse mean and variance of survival time for different obstacle configurations and
number of runs we average over. Need to find correct parameters for evolution. Ie. obstacle settings
and run numbers that reduce the amount of variance between runs and lead to a reliable mean that is
indicative of the creature's fitness."""
