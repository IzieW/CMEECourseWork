...
## Example 1: Variable scope in a block of code
i = 1
x = 0
for i in range(10):
    x += 1
...
x = 0
def a_function(y):
    """Illustrates scope of variable assigned within a function"""
    x = 0
    for i in range(y):
        x += 1
    return x
...
x = a_function(10)
print(x)  # x is now value returned in function
print(i)  # "i" is still at its previous value
