...
"""A series of control flow functions which can take arguments from the console"""
...
def foo_1(x):  # Returns x to the power of 0.05
    """Returns value to the power of 0.05"""
    return x ** 0.5
...
def foo_5(x):  # a recursive function that calculates the factorial of x
    """Returns factorial of f calculated recursively"""
    if x == 1:
        return 1
    return x * foo_5(x - 1)
...
def foo_6(x):  # Calculate the factorial of x in a different way
    """Returns factorial of f, once again"""
    facto = 1
    while x >= 1:
        facto = facto * x
        x = x - 1
